...
Future<void> displayBottomSheet_otherprofile(
  ...
  bool showEditListContent = false; // New state for Edit List content
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      if (selectedButton == 'Uploads')
                                        _buildUploadsContent(context, username),
                                      if (selectedButton == 'Reviews')
                                        _buildReviewsContent(userId),
...
Widget _buildUploadsContent(BuildContext context, String username) {
...
Widget _buildReviewsContent(String userId) {
          ...
          if (selectedLibraryButton == 'Pins') ...[
                              ...
                              if (value == 'report') {
                                showDialog(
                                  ...
                                  builder: (context) => AlertDialog(
                                    ...
                                    content: Text(
                                        'Are you sure you want to report this pin?'),
                                    actions: [
                                      TextButton(
                                        onPressed: () {
            ...
            StreamBuilder<QuerySnapshot>(
              stream: FirebaseFirestore.instance
                  ...
                  .where('userId', isEqualTo: userId)
                  .where('isPrivate',
                      isEqualTo: false) // Filter out private lists
                  .snapshots(),
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  return Center(child: CircularProgressIndicator());
                                ...
                                if (value == 'report') {
                                  showDialog(
                                    ...
                                    builder: (context) => AlertDialog(
                                      ...
                                      content: Text(
                                          'Are you sure you want to report this list?'),
                                      actions: [
                                        TextButton(
                                          onPressed: () {
                                            Navigator.of(context)
                            ...
                            try {
                              ...
                              if (locations.isNotEmpty) {
                                RouteService routeService = RouteService(
                                  ...
                                  routePoints: [],
                                  apiKey:
                                      'AIzaSyCffo3J5Oo5udtLKhLnR8Bzl2XT7f3CbHk',
                                );
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    _uploadData(context); // Pass context to _uploadData
                  },
                  style: ButtonStyle(
...
Widget _buildAddToListContent(
  ...
  final String _apiKey =
      'AIzaSyCffo3J5Oo5udtLKhLnR8Bzl2XT7f3CbHk'; // Replace with your actual API key
