                        ...
                        itemBuilder: (context, index) {
                          ...
                          return ListTile(
                            title: Text(
                             ...
                             onTap: () {
                              handlePlaceSelection(suggestion, true);
                              setState(() {
                                fromSuggestionsVisible = false; // Hide suggestions after selection
                              });
                            },
                          ...
                          ElevatedButton(
                            onPressed: () {
                                    ...
                                    routeService.showRoute(fromAddress: from, toAddress: to).then((_) {
                                      ...
                                      // Handle errors, such as failed route retrieval
                                    ...
                                    showContainer(context, 'Route is being displayed'); // Show the route display container

                                    showFAB = false; // Initially hide FAB while the container is shown
                                  },
                            style: ElevatedButton.styleFrom(
                              foregroundColor: Colors.white,
                              backgroundColor: Color.fromARGB(
                                  255, 80, 96, 116), // Set text color to white
                            ),
