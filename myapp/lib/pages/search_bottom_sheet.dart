...
class _SearchBottomSheetState extends State<SearchBottomSheet>
  ...
  void _searchPlaces(String query) async {
    ...
    final apiKey = 'AIzaSyCffo3J5Oo5udtLKhLnR8Bzl2XT7f3CbHk';
  ...
  String? _getPhotoUrl(String? photoReference) {
    ...
    final apiKey =
        'AIzaSyCffo3J5Oo5udtLKhLnR8Bzl2XT7f3CbHk'; // Replace with your Google Maps API key
  ...
  Future<Map<String, dynamic>> _fetchPlaceDetails(
    ...
    if (placeId.isNotEmpty) {
      ...
      const String apiKey = 'AIzaSyCffo3J5Oo5udtLKhLnR8Bzl2XT7f3CbHk';
      final String url =
...
Future<Map<String, dynamic>?> fetchPlaceDetails(String placeId) async {
  final apiKey = 'AIzaSyCffo3J5Oo5udtLKhLnR8Bzl2XT7f3CbHk';  // Replace with your actual API key
